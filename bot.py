...
# ============================================================
#  ⚠️ 湖北查询功能（/hb）— 使用域名 + 完整请求头（适配 GitHub 环境）
# ============================================================
from Crypto.Cipher import AES   # 需安装 pycryptodome 或使用内置

HB_KEY = b"ZBYSC2SGOYBVVHUZ"
HB_HOST = "scjg.hubei.gov.cn"    # 改用域名
...
def query_hubei(idcard: str):
    ...
    for i, item in enumerate(data_list, 1):
        ...
        dl_headers = {
            "Host": "zwfw.hubei.gov.cn",   # 注意下载接口的 Host 不同
